...
| `githubHost`         |                                   | GitHub hostname. Set this to the hostname of a GitHub Enterprise Server instance.   | `github.com`      | extracted from the URL of the GitHub remote   |
| `githubRemoteName`   |                                   | Name of the git remote in this local repository that corresponds to GitHub          | `origin`          | `origin`                                      |
| `githubRepository`   | `--github-repository`             | Name of the GitHub repository in `owner/repo` format                                |                   | extracted from the URL of the GitHub remote   |
